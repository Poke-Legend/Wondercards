# Mergebot-SpecialRequest-WonderCards
These are the Wonder Card files to use with my MergeBot Fork of Sysbot.NET.

Download the file and upload using the `trade` command.  

**Note:** Item wondercards cannot be used.
